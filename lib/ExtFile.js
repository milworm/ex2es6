...
var ExtFile = function () {
  ...
  */
   ...
   */
		...
		key: '_createClass',
		value: function _createClass(_ref3) {
			var classDefinition = _ref3.classDefinition;
			...
			_.each(properties, function (property, method) {
				...
				estraverse.traverse(property.value, {
					enter: function enter(node, parent) {
						_this2._replaceCallParent(method, node, parent, params);
					}
				});
			});
		}
   ...
   */
		...
		value: function _replaceCallParent(method, node, parent, params) {
			...
			if (callee.property.name != 'callParent') return;
			...
			var _ref4 = node.arguments || [];

			var _ref5 = _slicedToArray(_ref4, 1);

			var _ref5$ = _ref5[0];
			var firstArg = _ref5$ === undefined ? {} : _ref5$;

			node.arguments.unshift(object);

			// callParent(arguments)
			if (firstArg.name == 'arguments') node.arguments.push({
				type: 'Identifier',
				name: 'args'
			});
		}
