...
Ext.define('CJ.view.map.Block', {
     ...
     */
    initialize(...args) {
        this.superclass.initialize.apply(this, arguments, args);
    ...
    publish(options, ...args) {
        ...
        return this.superclass.publish.apply(this, arguments, args);
    },
    /**
     ...
     */
    onBlockCreated(...args) {
        this.superclass.onBlockCreated.apply(this, arguments, args);
        if (this.hasPageTags())
